...
gem 'mina', '1.2.3'
gem 'mina-puma', '1.1.0', require: false,  github: 'untitledkingdom/mina-puma'
gem 'mina-sidekiq', '1.0.3', require: false,  github: 'portabilis/mina-sidekiq', branch: 'mc-improve-tasks'
...
gem 'rails', '4.2.10'
gem 'rake', '11.1.2'
gem 'rdstation-ruby-client', '0.0.4'
