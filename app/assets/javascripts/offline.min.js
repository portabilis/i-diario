...
(function() {
  ...
  rc = Offline.reconnect = {}, retryIntv = null, reset = function() {
    ...
    rc.state = "inactive", rc.remaining = rc.delay = null != (ref = Offline.getOption("reconnect.initialDelay")) ? ref :6;
  }, next = function() {
    var delay, ref;
  ...
  TEMPLATE = '<div class="offline-ui"><p class="offline-ui-content"></p></div>',
  RETRY_TEMPLATE = '<a href class="offline-ui-retry"></a>', createFromHTML = function(html) {
    ...
    var button, handler;
    return el = createFromHTML(TEMPLATE), document.body.appendChild(el), null != Offline.reconnect && Offline.getOption("reconnect") && (el.children[0].appendChild(createFromHTML(RETRY_TEMPLATE)),
    ...
    return render(), Offline.on("up", function() {
      return removeClass("offline-ui-down"), addClass("offline-ui-up"), flashClass("offline-ui-up-2s", 3),
      flashClass("offline-ui-up-5s", 5);
    }), Offline.on("down", function() {
      return removeClass("offline-ui-up"), addClass("offline-ui-down"), flashClass("offline-ui-down-2s", 3),
