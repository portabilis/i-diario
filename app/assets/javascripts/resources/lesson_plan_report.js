$(function () {
  ...
  var $hideWhenGlobalAbsence = $(".hide-when-global-absence"),
      $globalAbsence = $("#lesson_plan_report_form_global_absence"),
  ...
  var $unity = $('#lesson_plan_report_form_unity_id');
  var $classroom = $('#lesson_plan_report_form_classroom_id');
  var $discipline = $('#lesson_plan_report_form_discipline_id');
  ...
  $unity.on('change', function (e) {
    ...
    $('#lesson_plan_report_form_class_numbers').select2("val", "")
