$(document).ready( function() {
  setTimeout(function(){
    let days_limit_message = 'É possível registrar frequência de no máximo 15 dias por lançamento, independente da quantidade de dias informados na seleção inicial.';
