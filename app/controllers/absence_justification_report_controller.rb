class AbsenceJustificationReportController < ApplicationController
  ...
  def report
    ...
    @absence_justification_report_form.unity = current_user_unity
    ...
    if @absence_justification_report_form.valid?
      ...
      send_data(absence_justification_report.render, filename: 'registro-de-justificativa-de-falta.pdf', type: 'application/pdf', disposition: 'inline')
    else
      fetch_classrooms
      render :form
    end
