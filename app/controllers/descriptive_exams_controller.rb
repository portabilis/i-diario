class DescriptiveExamsController < ApplicationController
  ...
  def find
    ...
    return render json: nil if params[:step_id].blank? && !opinion_type_by_year?(params[:opinion_type])
    ...
    descriptive_exam_id.by_step_id(current_user_classroom, step_id) if step_id
