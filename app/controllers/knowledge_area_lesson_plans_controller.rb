class KnowledgeAreaLessonPlansController < ApplicationController
  ...
  def content_ids
    ...
    new_contents_ids = content_descriptions.each_with_index.map { |description, index|
      ...
      @knowledge_area_lesson_plan.lesson_plan.contents_created_at_position[content.id] = global_index + index
      content.id
    }
  ...
  def objective_ids
    ...
    new_objectives_ids = objective_descriptions.each_with_index.map { |description, index|
      ...
      @knowledge_area_lesson_plan.lesson_plan.objectives_created_at_position[objective.id] = global_index + index
      objective.id
    }
