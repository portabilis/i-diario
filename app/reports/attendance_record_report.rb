class AttendanceRecordReport < BaseReport
  ...
  def daily_frequencies_table
    ...
    sliced_frequencies_and_events.each_with_index do |frequencies_and_events_slice, index|
      ...
      sliced_students_cells.each_with_index do |students_cells_slice, ii|
        data = [
        ...
        if ii == sliced_students_cells.count - 1 && index == sliced_frequencies_and_events.count - 1
        ...
        start_new_page if ii < sliced_students_cells.count - 1
      end
