class AttendanceRecordReport < BaseReport
  ...
  def self.build(entity_configuration, teacher, year, start_at, end_at, daily_frequencies, student_enrollments, events, school_calendar, second_teacher_signature, display_knowledge_area_as_discipline)
    new(:landscape)
  ...
  def build(entity_configuration, teacher, year, start_at, end_at, daily_frequencies, student_enrollments, events, school_calendar, second_teacher_signature, display_knowledge_area_as_discipline)
    ...
    @display_knowledge_area_as_discipline = ActiveRecord::Type::Boolean.new.type_cast_from_user(display_knowledge_area_as_discipline)
