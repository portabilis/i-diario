class KnowledgeAreaContentRecordReport < BaseReport
  ...
  def attributes
    ...
    @daily_record_cell = make_cell(content: @knowledge_area_content_records.first.content_record.daily_activities_record, borders: [:bottom, :left, :right], size: 10, width: 240, align: :left, padding: [0, 2, 4, 4], colspan: 2)
