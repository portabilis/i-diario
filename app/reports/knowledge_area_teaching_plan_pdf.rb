class KnowledgeAreaTeachingPlanPdf < BaseReport
  ...
  def attributes
    ...
    @period_cell = make_cell(content: (teaching_plan.yearly? ? teaching_plan.school_term_type_humanize : teaching_plan.school_term_type_step_humanize), size: 10, borders: [:bottom, :left, :right], padding: [0, 2, 4, 4], colspan: 2)
  end
