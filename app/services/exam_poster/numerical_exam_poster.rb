      ...
      classroom_ids.each do |classroom|
        ...
        teacher_discipline_classrooms.each do |teacher_discipline_classroom|
          ...
          student_scores.each do |student_score|
            ...
            scores[classroom.api_code][student_score.api_code][discipline.api_code]['recuperacao'] =
              fetch_school_term_recovery_score(classroom, discipline, student_score.id)
          end
