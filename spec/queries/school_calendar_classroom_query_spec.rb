...
RSpec.describe SchoolCalendarClassroomQuery, type: :query do
  ...
  describe '#school_calendar' do
    it 'return school_calendar when classroom year match to existing school_calendar' do
  ...
  describe '#school_calendar' do
    it 'return nil when classroom year doesnt match to existing school_calendar' do
